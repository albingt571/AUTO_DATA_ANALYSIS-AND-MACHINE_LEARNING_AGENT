...
def model_selection_train_and_evaluation(df, target_col, llm, test_size=0.2, random_state=42, cv_folds=5):
    ...
    if model_type == "classification":
        ...
        metrics_dict = {model._class.name_: {"accuracy": None, "precision": None, "recall": None, "f1_score": None} for model in models}
        ...
        metrics_dict = {model._class.name_: {"mean_squared_error": None} for model in models}
    else:
    ...
    models_used = [model_instance._class.name_ for model_instance in models]
    ...
    for model_instance in models:
        model_name = model_instance._class.name_
    ...
    summary = {
        ...
        "best_model": best_model._class.name_,  # Name of the best model
    ...
    structured_best_metrics = {
        "model_name": best_model._class.name_,
        "metrics": best_metrics,
        "parameters": best_hyperparameters.get(best_model._class.name_, {})
