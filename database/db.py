...
class Summary(SQLModel, table=True):
    ...
    all_models_metrics: Optional[Dict[str, Any]] = Field(default=None, sa_type=JSON)
...
def get_relevant_text(query: str, limit: int = 3) -> List[Dict[str, Any]]:
    ...
    try:
        with Session(engine) as session:
            ...
            conditions.append(cast(Summary.all_models_metrics, String).ilike(f"%{query}%"))
            ...
            return [{
                ...
                'model_metrics': result.all_models_metrics
